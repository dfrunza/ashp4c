...
CC=""
CC="$CC -g3 -std=c++11 -ggdb -fpermissive -fms-extensions"
CC="$CC -Wno-pointer-arith -Wno-sign-compare -Wno-nonnull-compare -Winline -Wno-write-strings"
...
g++ $CC -o ashp4c \
  ...
  lex.cpp ast.cpp ast_visitor.cpp scope.cpp \
