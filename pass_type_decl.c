...
visit_packageTypeDeclaration(Ast_PackageTypeDeclaration* package_decl)
{
  ...
  HashmapEntry_Type* type_he = hashmap_get_entry_uint32k(&type_table, package_decl->node_id, HashmapEntry_Type);
...
visit_parserTypeDeclaration(Ast_ParserTypeDeclaration* parser_decl)
{
  ...
  HashmapEntry_Type* type_he = hashmap_get_entry_uint32k(&type_table, parser_decl->node_id, HashmapEntry_Type);
...
visit_controlTypeDeclaration(Ast_ControlTypeDeclaration* control_decl)
{
  ...
  HashmapEntry_Type* type_he = hashmap_get_entry_uint32k(&type_table, control_decl->node_id, HashmapEntry_Type);
...
visit_externTypeDeclaration(Ast_ExternTypeDeclaration* extern_decl)
{
  ...
  HashmapEntry_Type* type_he = hashmap_get_entry_uint32k(&type_table, extern_decl->node_id, HashmapEntry_Type);
...
visit_functionPrototype(Ast_FunctionPrototype* func_proto)
{
  ...
  HashmapEntry_Type* type_he = hashmap_get_entry_uint32k(&type_table, func_proto->node_id, HashmapEntry_Type);
...
visit_headerTypeDeclaration(Ast_HeaderTypeDeclaration* header_decl)
{
  ...
  HashmapEntry_Type* type_he = hashmap_get_entry_uint32k(&type_table, header_decl->node_id, HashmapEntry_Type);
...
visit_headerUnionDeclaration(Ast_HeaderUnionDeclaration* union_decl)
{
  ...
  HashmapEntry_Type* type_he = hashmap_get_entry_uint32k(&type_table, union_decl->node_id, HashmapEntry_Type);
...
visit_structTypeDeclaration(Ast_StructTypeDeclaration* struct_decl)
{
  ...
  HashmapEntry_Type* type_he = hashmap_get_entry_uint32k(&type_table, struct_decl->node_id, HashmapEntry_Type);
...
visit_enumDeclaration(Ast_EnumDeclaration* enum_decl)
{
  ...
  HashmapEntry_Type* type_he = hashmap_get_entry_uint32k(&type_table, enum_decl->node_id, HashmapEntry_Type);
...
visit_typedefDeclaration(Ast_TypedefDeclaration* typedef_decl)
{
  ...
  HashmapEntry_Type* type_he = hashmap_get_entry_uint32k(&type_table, typedef_decl->node_id, HashmapEntry_Type);
...
visit_actionDeclaration(Ast_ActionDeclaration* action_decl)
{
  ...
  HashmapEntry_Type* type_he = hashmap_get_entry_uint32k(&type_table, action_decl->node_id, HashmapEntry_Type);
...
pass_type_decl(Ast_P4Program* p4program, Arena* _storage, Scope* root_scope)
{
  ...
  for (int i = 0; i < sizeof(basic_types)/sizeof(basic_types[0]); i++) {
    ...
    hashmap_get_entry_uint32k(
      &type_table, namedecl->ast->node_id, HashmapEntry_Type)->type = (Type*)basic_ty;
  }
