...
internal void
resolve_names_instantiation(struct Scope* scope, struct Ast* decl)
{
...
internal void
resolve_names_function_call(struct Scope* scope, struct Ast* expr)
{
...
internal void
resolve_names_expression(struct Scope* scope, struct Ast* expr)
{
  if (expr->kind == Ast_BinaryExpr) {
    ...
    resolve_names_function_call(scope, expr);
...
internal void
resolve_names_function_param(struct Scope* scope, struct Ast* param)
{
...
internal void
resolve_names_action_decl(struct Scope* scope, struct Ast* decl)
{
...
internal void
resolve_names_select_keyset(struct Scope* scope, struct Ast* keyset)
{
  if (keyset->kind == Ast_TupleKeyset) {
    ...
    resolve_names_keyset_expr(scope, keyset);
  }
}

internal void
resolve_names_action_ref(struct Scope* scope, struct Ast* action)
{
...
internal void
resolve_names_table_keyelem(struct Scope* scope, struct Ast* keyelem)
{
...
internal void
resolve_names_table_entry(struct Scope* scope, struct Ast* entry)
{
...
internal void
resolve_names_table_property(struct Scope* scope, struct Ast* prop)
{
...
internal void
resolve_names_table_decl(struct Scope* scope, struct Ast* decl)
{
...
internal void
resolve_names_method_call(struct Scope* scope, struct Ast* stmt)
{
...
internal void
resolve_names_switch_case(struct Scope* scope, struct Ast* switch_case)
{
...
internal void
resolve_names_statement(struct Scope* scope, struct Ast* stmt)
{
  if (stmt->kind == Ast_IfStmt) {
    ...
    resolve_names_method_call(scope, stmt);
    ...
    resolve_names_action_decl(scope, stmt);
  } else if (stmt->kind == Ast_Instantiation) {
    resolve_names_instantiation(scope, stmt);
  } else if (stmt->kind == Ast_TableDecl) {
    resolve_names_table_decl(scope, stmt);
...
internal void
resolve_names_type_ref(struct Scope* scope, struct Ast* type_ref)
{
  if (type_ref->kind == Ast_BaseType) {
    ...
    resolve_names_expression(scope, type_ref);
...
internal void
resolve_names_transition_select_case(struct Scope* scope, struct Ast* select_case)
{
...
internal void
resolve_names_parser_transition(struct Scope* scope, struct Ast* trans_stmt)
{
  if (trans_stmt->kind == Ast_Name) {
    resolve_names_expression(scope, trans_stmt);
...
internal void
resolve_names_parser_state(struct Scope* scope, struct Ast* state)
{
...
internal void
resolve_names_control_decl(struct Scope* scope, struct Ast* decl)
{
...
internal void
resolve_names_const_decl(struct Scope* scope, struct Ast* decl)
{
...
internal void
resolve_names_function_proto(struct Scope* scope, struct Ast* decl)
{
...
internal void
resolve_names_package(struct Scope* scope, struct Ast* decl)
{
...
internal void
resolve_names_parser_decl(struct Scope* scope, struct Ast* decl)
{
...
internal void
resolve_names_function_decl(struct Scope* scope, struct Ast* decl)
{
...
internal void
resolve_names_extern_decl(struct Scope* scope, struct Ast* decl)
{
...
internal void
resolve_names_enum_specified_id(struct Scope* scope, struct Ast* id)
{
...
internal void
resolve_names_enum_decl(struct Scope* scope, struct Ast* decl)
{
...
void
resolve_names_type_decl(struct Scope* scope, struct Ast* decl)
{
...
internal void
resolve_names_struct_decl(struct Scope* scope, struct Ast* decl)
{
...
internal void
resolve_names_header_decl(struct Scope* scope, struct Ast* decl)
{
...
internal void
resolve_names_header_union_decl(struct Scope* scope, struct Ast* decl)
{
...
void
resolve_names_program(struct Ast* program)
{
