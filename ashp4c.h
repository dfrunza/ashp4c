...
Ast*            parse_program(char* source_file, UnboundedArray* tokens, Arena* storage,
                    Scope** root_scope);
...
Set* build_type_table(char* source_file, Ast* p4program, Scope* root_scope, Set* opened_scopes,
          Set* enclosing_scopes, Set* decl_table, Arena* storage);
