...
Pass_NameDecl*  pass_name_decl(Ast_P4Program* p4program, Arena* storage, Scope* root_scope);
Hashmap* pass_type_decl(Ast_P4Program* p4program, Arena* storage, Scope* root_scope);
Hashmap* pass_potential_type(Ast_P4Program* p4program, Arena* storage, Scope* root_scope,
            Hashmap* scopes, Hashmap* type_table);
