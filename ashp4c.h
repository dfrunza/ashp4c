...
void            name_decl(Ast_P4Program* ast, Scope* root_scope, Hashmap** scope_map, Hashmap** field_map, Arena* storage);
Hashmap*        type_decl(Ast_P4Program* ast, Arena* storage);
Hashmap*        potential_type(Ast_P4Program* ast, Scope* root_scope, Arena* storage,
