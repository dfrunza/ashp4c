...
#clang $LINUX_INCLUDE -O2 -Wall -target bpf -c $SRC/xdp_example_drop.c -o xdp_example_drop.o
...
clang -g -ggdb -static $LINUX_INCLUDE -O2 -Wall $SRC/xdp_redirect_user.c -o xdp_redirect_user -L . bpf_load.o -lbpf -lelf -lz
popd
