...
visit_struct(Ast* ast)
{
  ...
  HashmapEntry* struct_he = hashmap_get_entry_uint32(&type_table, struct_decl->id);
...
build_type_decl(Ast_P4Program* p4program, Scope* root_scope_, Arena* type_storage_)
{
...

  {
    ...
    HashmapEntry* bit_he = hashmap_get_entry_uint32(&type_table, void_decl->id);
  ...
  }
  {
    ...
    HashmapEntry* bool_he = hashmap_get_entry_uint32(&type_table, bool_decl->id);
  ...
  }
  {
    ...
    HashmapEntry* bit_he = hashmap_get_entry_uint32(&type_table, int_decl->id);
  ...
  }
  {
    ...
    HashmapEntry* bit_he = hashmap_get_entry_uint32(&type_table, bit_decl->id);
  ...
  }
  {
    ...
    HashmapEntry* varbit_he = hashmap_get_entry_uint32(&type_table, varbit_decl->id);
  ...
  }
  {
    ...
    HashmapEntry* string_he = hashmap_get_entry_uint32(&type_table, string_decl->id);
