...
visit_name(Ast* name)
{
  ...
  m = set_add(storage, enclosing_scopes, name, current_scope, 0);
  assert(m);
}
...
visit_parameter(Ast* param)
{
  ...
  set_add(storage, decl_map, param, name_decl, 0);
...
visit_packageTypeDeclaration(Ast* type_decl)
{
  ...
  set_add(storage, decl_map, name, name_decl, 0);
  set_add(storage, decl_map, type_decl, name_decl, 0);
...
visit_instantiation(Ast* inst)
{
  ...
  name_decl->ast = inst;
  set_add(storage, decl_map, name, name_decl, 0);
  set_add(storage, decl_map, inst, name_decl, 0);
}
...
visit_parserState(Ast* state)
{
  ...
  name_decl->ast = state;
  set_add(storage, decl_map, name, name_decl, 0);
  set_add(storage, decl_map, state, name_decl, 0);
...
visit_functionPrototype(Ast* func_proto)
{
  ...
  set_add(storage, decl_map, name, name_decl, 0);
  set_add(storage, decl_map, func_proto, name_decl, 0);
...
visit_baseTypeBoolean(Ast* bool_type)
{
  ...
  set_add(storage, decl_map, bool_type, name_decl, 0);
}
...
visit_baseTypeInteger(Ast* int_type)
{
  ...
  name_decl = name_entry_getdecl(name_entry, NAMESPACE_TYPE);
  set_add(storage, decl_map, int_type, name_decl, 0);
}
...
visit_baseTypeBit(Ast* bit_type)
{
  ...
  name_decl = name_entry_getdecl(name_entry, NAMESPACE_TYPE);
  set_add(storage, decl_map, bit_type, name_decl, 0);
}
...
visit_baseTypeVarbit(Ast* varbit_type)
{
  ...
  name_decl = name_entry_getdecl(name_entry, NAMESPACE_TYPE);
  set_add(storage, decl_map, varbit_type, name_decl, 0);
}
...
visit_baseTypeString(Ast* str_type)
{
  ...
  name_decl = name_entry_getdecl(name_entry, NAMESPACE_TYPE);
  set_add(storage, decl_map, str_type, name_decl, 0);
}
...
visit_baseTypeVoid(Ast* void_type)
{
  ...
  name_decl = name_entry_getdecl(name_entry, NAMESPACE_TYPE);
  set_add(storage, decl_map, void_type, name_decl, 0);
}
...
visit_baseTypeError(Ast* error_type)
{
  ...
  name_decl = name_entry_getdecl(name_entry, NAMESPACE_TYPE);
  set_add(storage, decl_map, error_type, name_decl, 0);
}
...
visit_headerTypeDeclaration(Ast* header_decl)
{
  ...
  set_add(storage, decl_map, name, name_decl, 0);
  set_add(storage, decl_map, header_decl, name_decl, 0);
...
visit_headerUnionDeclaration(Ast* union_decl)
{
  ...
  set_add(storage, decl_map, name, name_decl, 0);
  set_add(storage, decl_map, union_decl, name_decl, 0);
...
visit_structTypeDeclaration(Ast* struct_decl)
{
  ...
  set_add(storage, decl_map, name, name_decl, 0);
  set_add(storage, decl_map, struct_decl, name_decl, 0);
...
visit_structField(Ast* field)
{
  ...
  name_decl->ast = field;
  set_add(storage, decl_map, name, name_decl, 0);
  set_add(storage, decl_map, field, name_decl, 0);
}
...
visit_enumDeclaration(Ast* enum_decl)
{
  ...
  set_add(storage, decl_map, name, name_decl, 0);
  set_add(storage, decl_map, enum_decl, name_decl, 0);
...
visit_specifiedIdentifier(Ast* ident)
{
  ...
  name_decl->ast = ident;
  set_add(storage, decl_map, name, name_decl, 0);
  set_add(storage, decl_map, ident, name_decl, 0);
...
visit_typedefDeclaration(Ast* typedef_decl)
{
  ...
  set_add(storage, decl_map, name, name_decl, 0);
  set_add(storage, decl_map, typedef_decl, name_decl, 0);
}
...
visit_tableDeclaration(Ast* table_decl)
{
  ...
  set_add(storage, decl_map, name, name_decl, 0);
  set_add(storage, decl_map, table_decl, name_decl, 0);
...
visit_simpleProperty(Ast* simple_prop)
{
  ...
  set_add(storage, decl_map, name, name_decl, 0);
  set_add(storage, decl_map, simple_prop, name_decl, 0);
...
visit_actionDeclaration(Ast* action_decl)
{
  ...
  set_add(storage, decl_map, name, name_decl, 0);
  set_add(storage, decl_map, action_decl, name_decl, 0);
...
visit_variableDeclaration(Ast* var_decl)
{
  ...
  set_add(storage, decl_map, name, name_decl, 0);
  set_add(storage, decl_map, var_decl, name_decl, 0);
...
visit_booleanLiteral(Ast* bool_literal)
{
  ...
  name_entry = scope_lookup(root_scope, "bool", NAMESPACE_TYPE);
  name_decl = name_entry_getdecl(name_entry, NAMESPACE_TYPE);
  set_add(storage, decl_map, bool_literal, name_decl, 0);
}
...
visit_integerLiteral(Ast* int_literal)
{
  ...
  name_decl = name_entry_getdecl(name_entry, NAMESPACE_TYPE);
  set_add(storage, decl_map, int_literal, name_decl, 0);
}
...
visit_stringLiteral(Ast* str_literal)
{
  ...
  name_entry = scope_lookup(root_scope, "string", NAMESPACE_TYPE);
  name_decl = name_entry_getdecl(name_entry, NAMESPACE_TYPE);
  set_add(storage, decl_map, str_literal, name_decl, 0);
}
...
visit_dontcare(Ast* dontcare)
{
  ...
  name_decl = name_entry_getdecl(name_entry, NAMESPACE_TYPE);
  set_add(storage, decl_map, dontcare, name_decl, 0);
}
